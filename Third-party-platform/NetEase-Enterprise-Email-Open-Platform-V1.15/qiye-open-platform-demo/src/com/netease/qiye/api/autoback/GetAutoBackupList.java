package com.netease.qiye.api.autoback;
 ...
 * @author NetEase
 */
public class GetAutoBackupList extends TokenKeeper {

    public static final String apiPath = "/api/open/autobackup/getAutoBackupList";
