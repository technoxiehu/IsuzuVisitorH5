 ...
 * @author NetEase
 */
public class GetAccountAliasList extends TokenKeeper {

    public static final String apiPath = "/api/open/account/getAccountAliasList";

    public static final String accessToken = "3ff386dd12014a26a7cad7859d442127";
