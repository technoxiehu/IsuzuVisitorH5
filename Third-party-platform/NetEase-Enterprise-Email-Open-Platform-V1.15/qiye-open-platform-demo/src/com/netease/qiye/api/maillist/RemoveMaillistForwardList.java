 ...
 * @author NetEase
 */
public class RemoveMaillistForwardList extends TokenKeeper {

    public static final String apiPath = "/api/open/maillist/removeMaillistForwardList";
    ...
    public static void main(String[] args) {
        ...
        Q q = Q.init(null)
                ...
                //需要删除的邮件列表成员（邮箱）,用英文逗号 , 隔开的邮件地址列表 例如\ntest1@test.com,test2@test.com
