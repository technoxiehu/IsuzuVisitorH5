package com.netease.qiye.api.archive;
 ...
 * @author NetEase
 */
public class DeleteArchiveMailAccount extends TokenKeeper {

    public static final String apiPath = "/api/open/archive/deleteArchiveMailAccount";
