 ...
 * @author NetEase
 */
public class MoveUnit extends TokenKeeper {

    public static final String apiPath = "/api/open/unit/moveUnit";
    ...
    public static void main(String[] args) {
        ...
        Q q = Q.init(null)
                ...
                //部门ID，查询部门返回
                .addParam("unitId", "")
                //期望父部门id，设定为顶级/根部门，则为值为'root'
                .addParam("unitParentId", "root")
                ;
