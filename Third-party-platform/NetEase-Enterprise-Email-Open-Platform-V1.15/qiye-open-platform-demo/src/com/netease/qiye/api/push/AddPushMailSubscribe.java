 ...
 * @author NetEase
 */
public class AddPushMailSubscribe extends TokenKeeper {

    public static final String apiPath = "/api/open/push/addPushMailSubscribe";
    ...
    public static void main(String[] args) {
        ...
        Q q = Q.init(null)
                ...
                .addParam("accountName","test12321321")
                ;
